...
<head>
    ...
    <title>{{ config('app.name', 'IDLReport') }}</title>

    <!-- Scripts -->
    <script src="{{ asset('js/app.js') }}" defer></script>

    {{-- Script For Admin Panel 2 --}}
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html">Register New User</a>
    ...
    {{-- <script src="{{url('public/template')}}/asset/js/bootstrap.min.js"></script> --}}

    <!-- Bootstrap core JavaScript-->
    {{-- <script src="vendor/jquery/jquery.min.js"></script> --}}
    <script src="{{ url('vendor/jquery/jquery.min.js') }}"></script>j
